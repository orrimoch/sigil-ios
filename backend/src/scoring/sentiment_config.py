...
class SentimentConfig:
    ...
    claude_model: str = "claude-3-haiku-20240307"  # REC-304: updated from deprecated 20241022
...
def load_sentiment_config() -> SentimentConfig:
    ...
    Environment Variables:
        ...
        SENTIMENT_CLAUDE_MODEL: Claude model to use (default: claude-3-haiku-20240307)
    ...
    config = SentimentConfig(
        ...
        claude_model=os.environ.get("SENTIMENT_CLAUDE_MODEL", "claude-3-haiku-20240307"),
